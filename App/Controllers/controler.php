...
class TaskController {
   ...
   public function showHome(){
    ...
    public function showaddActividad(){
        ...
        $club=$this->model->getinfoClub();

        return $this->view->ModificarActividad($cate,$acti,$club);
    }
  ...
  //agregar
    ...
    public function agregarActividad() {
        ...
        $id = $this->model->insertActividad($depor,$hora,$dia,$profe,$cate,$imagen,$pago);
    ...
    public function editarActividad(){
        ...
        $id = $this->model->editarActi($hora,$dia,$pago,$identificador);
